...
type StorageClient interface {
	Save(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error)
...
func (c *storageClient) Save(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	out := new(TaskResponse)
	err := c.cc.Invoke(ctx, "/api.Storage/Save", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StorageServer interface {
	Save(context.Context, *TaskRequest) (*TaskResponse, error)
...
func (UnimplementedStorageServer) Save(context.Context, *TaskRequest) (*TaskResponse, error) {
...
func _Storage_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Storage/Save",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).Save(ctx, req.(*TaskRequest))
	}
...
var Storage_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "task5/protoc/api.proto",
}
